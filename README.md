...
4. บันทึกผล
     ...
     จากผลการทดลอง พบว่า เมื่อเราเขียน Code ตามที่ใบงานกำหนดแล้ว เมื่อทำการรันผลโปรแกรมจะปรากฎ Block มีมีรูปวงรีข้างใน ดังรูปต่อไปนี้

![](https://github.com/fernkamon/LAB-02/blob/master/Lab2.PNG)
...
1.	นักศึกษาพบปัญหาในกานคอมไพล์โปรแกรมหรือไม่ ถ้าเจอให้บอกที่ผิดและแนวทางการแก้ไข
     ...
     ไม่พบปัญหาใดๆ นอกจากว่า เขียนCodeผิดทำใคอมไพล์โปรแกรมแล้วเกิด Error
